			...
			<tbody id="tableBody">
                <c:forEach items="${book}" var="b" varStatus="customers">
                    <tr>
                       ...
                       <td><button class="btn2 btn-danger" id="<c:out value="${b.bookId}"/>" onclick="confirmation(this.id)">REJECT</button></td>
                        <td><a href="PaymentListController" class="btn3">ACCEPT</a></td>
                    </tr>
                    </c:forEach>
			</tbody>
		</table>
